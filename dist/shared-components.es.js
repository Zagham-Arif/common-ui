...
function ur() {
  if (Te)
    return k;
  Te = 1;
  var b = Ce, S = Symbol.for("react.element"), V = Symbol.for("react.fragment"), R = Object.prototype.hasOwnProperty, F = b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, A = { key: !0, ref: !0, __self: !0, __source: !0 };
  function w(y, l, T) {
...
function sr() {
  return Oe || (Oe = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function Ae(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === R || e === A || Fe || e === F || e === T || e === v || De || e === I || xe || je || ke || typeof e == "object" && e !== null && (e.$$typeof === _ || e.$$typeof === g || e.$$typeof === w || e.$$typeof === y || e.$$typeof === l || // This needs to include all possible module reference object
    ...
    var m = Object.assign, x = 0, re, te, ne, ae, oe, ie, ue;
    function se() {
    }
    ...
    function Ve(e, r, t, n, i) {
      {
        ...
        for (var o in e)
          if (u(e, o)) {
            ...
            a && !(a instanceof Error) && (N(i), c("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", n || "React class", t, o, typeof a), N(null)), a instanceof Error && !(a.message in le) && (le[a.message] = !0, N(i), c("Failed %s type: %s", t, a.message), N(null));
          }
      }
    }
    ...
    function Ze(e, r, t, n, i) {
      {
        ...
        return Xe(e, a, d, i, n, j.current, o);
      }
    }
...
var X = H.exports;
const lr = ({ text: b }) => /* @__PURE__ */ X.jsx("button", { children: b }), cr = ({ text: b }) => /* @__PURE__ */ X.jsxs("button", { children: [
  " ",
  b
] }), dr = ({ text: b }) => /* @__PURE__ */ X.jsx("input", { type: "text", value: b });
export {
  cr as AddButton,
  lr as Button,
  dr as Field
